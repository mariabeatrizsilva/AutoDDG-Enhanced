...
from .generate_description import DatasetDescriptionGenerator
...
def get_various_descriptions(temperatures, description_words, use_semantic_profile_choices,
                             client, model_name, dataset_sample, dataset_profile, semantic_profile,
                             data_topic, 
                             verbose=False):
    ...
    for temperature in temperatures:
        for num_words in description_words:
            description_generator = DatasetDescriptionGenerator(client=client,
